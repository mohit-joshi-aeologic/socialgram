...
import 'package:socialgram/view_screen/comment_widget.dart';
import 'package:socialgram/view_screen/heart_icon_animator.dart';
...
class _PostWidgetState extends State<PostWidget> {
  ...
  void showWebColoredToast() {
    ...
    Fluttertoast.showToast(
      msg: " Done ",
      toastLength: Toast.LENGTH_SHORT,backgroundColor: Color(0xffEBAAA1),
      /*webBgColor: "#e74c3c",*/
                  ...
                  final action = CupertinoActionSheet(
                    ...
                    actions: <Widget>[
                      CupertinoActionSheetAction(
                        child: Text("Report",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                        isDefaultAction: true,
                        onPressed: () {


                          Navigator.pop(context,showSnackbar(context, 'Done'));
                          print("Action 1 is been clicked");
                        },
                      ),
                      CupertinoActionSheetAction(
                        child: Text("Turn On Post Notifications",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                      ...
                      CupertinoActionSheetAction(
                        child: Text("Copy Link ",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                        isDefaultAction: true,
                        onPressed: () {
                          print("Action 1 is been clicked");
                        },
                      ...
                      CupertinoActionSheetAction(
                        child: Text("Share ",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                        isDestructiveAction: false,
                        onPressed: () {
                          print("Action 2 is been clicked");
                        },
                      ...
                      CupertinoActionSheetAction(
                        child: Text("Unfollow",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                      ...
                      CupertinoActionSheetAction(
                        child: Text("Mute",style: TextStyle(color: Colors.black,fontFamily: 'Gilroylight',fontWeight: FontWeight.w900),),
                        isDestructiveAction: false,
                        onPressed: () {
                          print("Action 2 is been clicked");
                        },
